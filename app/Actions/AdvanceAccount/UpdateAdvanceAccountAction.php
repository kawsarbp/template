...
class UpdateAdvanceAccountAction
{
    public function execute(AdvancedAccount $advancedAccount, array $data): AdvanceAccountDetailResource
    {
        ...
        $advanceAccount = tap($advancedAccount)->update($data);
