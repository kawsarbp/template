...
import { ensureLeadingSlash, formatDateToYMD } from '@/lib/helper';
...
export default function SaleMultiplePayment(props) {
    const { t } = useLanguage();
    const sales = props?.data?.data || [];
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <FileUpload
                                files={files}
                                setFiles={setFiles}
                                endpoint="/sales/upload-attachment"
                                allowMultiple={true}
